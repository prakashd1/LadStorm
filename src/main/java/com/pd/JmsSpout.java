...
//			connection.setClientID(Thread.currentThread().getName());
			...
			TopicSubscriber ts=session.createDurableSubscriber((Topic)dest, "testTopic");
	...
	public void nextTuple() {
		...
		System.out.println("Calling nextTuple size of queue " + queue.size() + "  toCommit:" + this.toCommit.size() + "  pendingMessges:"+ this.pendingMessages.size() );
